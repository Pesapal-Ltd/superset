...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def init_views(self) -> None:
        ...
        from superset.views.device_fingerprint import (
            DeviceFingerprintRestApi,
        ...
        appbuilder.add_link(
            ...
            label=_("Email Verification Templates"),
        ...
        appbuilder.add_link(
            ...
            label=_("Email Verification Audit Log"),
        ...
        appbuilder.add_link(
            ...
            label=_("Blocked Device Fingerprints"),
