...
const SliceHeaderControls = (
  ...
  if (emailVerifyEnabled && hasRowsSelected) {
    newMenuItems.push({
      key: MenuKeys.SendVerificationEmail,
      label: (
        <span data-test="send-verification-email-menu-item">
          <Icons.MailOutlined
            css={css`
              margin-right: 8px;
              color: #1890ff;
  ...
  if (settlementEnabled && hasRowsSelected) {
    newMenuItems.push({
      key: MenuKeys.HoldFunds,
      label: (
        <span data-test="hold-funds-menu-item">
          <Icons.LockOutlined
            css={css`
              margin-right: 8px;
              color: #fa8c16;
  ...
  if (deviceFingerprintBlockEnabled && hasRowsSelected) {
    newMenuItems.push({
      key: MenuKeys.BlockDeviceFingerprint,
      label: (
        <span data-test="block-device-fingerprint-menu-item">
