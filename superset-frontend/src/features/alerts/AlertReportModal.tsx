                ...
                ]),
            {
              ...
              children: (
                <>
                        ...
                        <div className="input-container select-with-open-btn">
                          ...
                          >
                            <Button
                              ...
                              onClick={() => {
                                if (currentAlert?.chart?.value) {
                                  window.open(
                                    `/explore/?slice_id=${currentAlert.chart.value}`,
                                    '_blank',
                                    'noopener,noreferrer',
                                  );
                                }
                      ...
                      <>
                        ...
                        <div className="input-container select-with-open-btn">
                          ...
                          <Tooltip
                            title={
                              currentAlert?.dashboard?.value
                                ? t('Open dashboard in new tab')
                                : t('Select a dashboard first')
                            }
                            placement="top"
                          >
                            <Button
                              ...
                              onClick={() => {
                                if (currentAlert?.dashboard?.value) {
                                  window.open(
                                    `/superset/dashboard/${currentAlert.dashboard.value}/`,
                                    '_blank',
                                    'noopener,noreferrer',
                                  );
                                }
                  ...
                  {/* Format type is not applicable for Alerts */}
                  {isReport && (
                    <StyledInputContainer
                      css={
                        !isReport &&
